...
const Signup1 = ({ onSubmit, loading, error }: SignupProps) => {
          ...
          <div className="form-container relative z-10 h-full flex flex-col justify-center py-10">
            <form className='text-center grid gap-6 h-auto' onSubmit={handleSubmit}>
              ...
              <div className='grid gap-4 mb-2'>
                <h1 className='text-3xl md:text-4xl font-extrabold text-[var(--color-heading)] tracking-wider uppercase' onClick={(e) => {e.preventDefault()}}>Activate System</h1>
                ...
                <span className='text-sm text-[var(--color-text-secondary)] mt-2 block'>or register with secure email</span>
              </div>
              ...
              <div className="mt-2 text-right">
                 <a href="/login" className='font-light text-sm text-[var(--color-text-secondary)] hover:text-white transition-colors'>Already have an account? Sign In</a>
              </div>
              ...
              <div className='flex justify-center items-center mt-4'>
                ...
                >
                  <span className="relative z-10 tracking-widest uppercase">{loading ? 'Creating Account...' : 'Sign Up'}</span>
